	...
	$shortcode = $data['shortcode'];
		...
		if($ImageComplete)
		{
			...
			if($editid==0){
				...
				mysqli_query($db,"INSERT INTO owners VALUES (null,'$owner_name','$owner_id','$owner_email','$address2','$password','$owner_tel','2')");
				...
				header("location:../detailview.php?employeeid=$autoInc_id");exit;
			}
			else
			{
				if(!empty($_FILES['pfimg']['name']))
